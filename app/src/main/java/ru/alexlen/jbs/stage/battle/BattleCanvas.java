...
import ru.alexlen.jbs.RenderTask;
...
public class BattleCanvas {
    ...
    public enum Task {Strike}

    private static final EnumMap<Task, RenderTask> actions = new EnumMap<>(Task.class);
...
//    public void strike(final Cell cell) {
//        grid.drawCell(x, y, Styles.get("fared_area"));
//    }
